...
| Map Rendering | cavekit-map-rendering.md | 7 (R1–R7) | DRAFT | Projection, bundled basemap outlines and Chișinău marker, cloud heatmap, precipitation overlay, legend/status/attribution, popup chrome and bar icon. |
