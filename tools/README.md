...
Regenerates `data/outlines.json` from Natural Earth 50m source data:
...
python3 tools/build-outlines.py /tmp/ne_countries.geojson /tmp/ne_marine.geojson data/outlines.json
```
